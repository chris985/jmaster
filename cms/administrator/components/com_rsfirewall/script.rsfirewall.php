...
.com-rsfirewall-button {
	...
	<div id="installer-right">
		...
		<h2>Changelog v2.8.7</h2>
		<ul class="version-history">
			<li><span class="version-upgraded">Upg</span> 'Automatic blacklisting for /administrator login' is now independent of the 'Automatic blacklisting' option.</li>
			<li><span class="version-upgraded">Upg</span> 'Enable CAPTCHA' is now independent of the 'Automatic blacklisting for /administrator login' option.</li>
			<li><span class="version-fixed">Fix</span> Dashboard message that a file has been modified persisted even after replacing the file with the correct version.</li>
			<li><span class="version-fixed">Fix</span> Logging in successfully now resets the number of login attempts to 0.</li>
			<li><span class="version-fixed">Fix</span> 'Monitor the following files for changes' was not being loaded correctly from the Configuration.</li>
			<li><span class="version-fixed">Fix</span> When using a PDO MySQL database an error was thrown.</li>
			<li><span class="version-fixed">Fix</span> Longer texts in the System Logs areas were showing outside of their bounding area.</li>
		</ul>
